            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400">
                  Five open-source scanners — <span className="text-gray-200">Bastion</span>, <span className="text-gray-200">Bulwark</span>, <span className="text-gray-200">Lattice</span>, <span className="text-gray-200">Portcullis</span>, and <span className="text-gray-200">Stowaway</span> — that share one design DNA: offline, deterministic, SARIF output, <span className="font-mono text-xs">--fail-on</span> CI gates, and defensive-only. 1,200+ tests, 0–1 runtime deps.
                </p>
              </div>
