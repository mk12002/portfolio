...
export const fallbackProfile = {
  name: "Mohit Kumar",
  tagline: "Cybersecurity & AI Engineer",
  shortIntro: "Cybersecurity & AI Engineer building intelligent defense systems. Currently at ITC Infotech — engineering multi-agentic email threat neutralization, conducting VAPT, and running SOC operations. Deep ML background across adversarial robustness, multi-agent systems, and neural-symbolic reasoning.",
  longIntro: "I'm a Cybersecurity & AI Engineer at ITC Infotech, blending deep AI/ML expertise with security operations. I specialize in building intelligent defense systems — from multi-agentic email threat neutralization to SOC-grade anomaly detection — while researching adversarial robustness to secure AI from attack. My security toolkit spans VAPT (Burp Suite, Nmap, sqlmap, Nessus), SOC operations (Splunk, Microsoft Sentinel, Defender EDR/XDR), cloud security, and DevSecOps. Before pivoting to security, I built production-grade ML systems — Legal AI (HybEx-Law, 98.5% F1), multi-agent research platforms, and computer vision systems (98.99% mAP). I believe the future of security is AI-native — and the future of AI must be secure.",
  interests: [
    "AI for Security",
    "Security for AI",
    "Cybersecurity",
  ...
  socialLinks: {
    ...
    twitter: "https://x.com/mohitkr111",
...
export const fallbackResume = {
  name: "Mohit Kumar",
  title: "Cybersecurity & AI Engineer | VIT Chennai",
...
export const fallbackCertificates = {
  certificates: [
    { name: "Machine Learning Specialization", issuer: "DeepLearning.AI • Stanford University", category: "Data Science", icon: "brain", credentialId: "AAXPQV21SC8M", earnedDate: "March 2026", link: "https://www.coursera.org/account/accomplishments/specialization/AAXPQV21SC8M", description: "Foundational Machine Learning program covering supervised learning, unsupervised learning, and reinforcement learning. Emphasizes building production-ready ML systems.", skills: ["Machine Learning", "Neural Networks", "Supervised Learning", "Unsupervised Learning", "Reinforcement Learning", "Python"] },
    { name: "Python Data Structures", issuer: "University of Michigan", category: "Programming", icon: "python", credentialId: "HB5ZGUHXPTD4", earnedDate: "April 2026", link: "https://www.coursera.org/account/accomplishments/verify/HB5ZGUHXPTD4", description: "Introduction to the core data structures of the Python programming language.", skills: ["Python Programming", "Data Structures", "Tuple", "List", "Dictionary"] },
    ...
    { name: "Microsoft Certified: Azure AI Apps and Agents Developer Associate", issuer: "Microsoft", category: "Cloud", icon: "microsoft", credentialId: "F22D515FB88750A5", certificationNumber: "4C2150-EHE2B4", earnedDate: "June 20, 2026", expiryDate: "June 21, 2027", link: "https://learn.microsoft.com/en-us/users/mohitkumar-5451/credentials/f22d515fb88750a5", description: "Validates the skills to plan and manage Azure AI solutions and build generative AI and agentic applications using Azure AI services — spanning computer vision, text analysis, and information extraction.", skills: ["Plan and manage an Azure AI solution", "Generative AI & Agentic Solutions", "Computer Vision", "Text Analysis", "Information Extraction"] },
    { name: "Microsoft Certified: Azure AI Engineer Associate", issuer: "Microsoft", category: "Cloud", icon: "microsoft", credentialId: "FB7576BAB685E9BE", earnedDate: "June 17, 2025", expiryDate: "June 18, 2027", link: "https://learn.microsoft.com/en-us/users/mohitkumar-5451/credentials/fb7576bab685e9be", description: "Demonstrates expertise in designing and implementing AI solutions using Azure Cognitive Services, Azure Machine Learning, and Knowledge Mining." },
    { name: "Microsoft Certified: Azure Data Scientist Associate", issuer: "Microsoft", category: "Cloud", icon: "microsoft", credentialId: "2117BF954DCDC5A5", earnedDate: "June 18, 2025", expiryDate: "June 19, 2026", expired: true, link: "https://learn.microsoft.com/en-us/users/mohitkumar-5451/credentials/2117bf954dcdc5a5", description: "Validates skills in applying machine learning techniques using Azure Machine Learning." },
...
export const fallbackEvents = {
  events: [
    { title: "ITC Infotech Leadership Presentations", year: 2026, description: "Recognized for outstanding technical contributions by being repeatedly shortlisted to present the Agentic Email Security architecture to executive leadership. Conducted comprehensive technical deep-dives and strategic overview sessions for the VP of Cybersecurity, VP of Workforce Management, Director of Learning & Development, President of Business Excellence, and the CHRO. Successfully articulated the business value of transitioning from traditional SOC alert mechanisms to autonomous multi-agent threat neutralization, demonstrating the ability to bridge complex AI-security concepts with overarching corporate strategy.", type: "presentation" },
    { title: "AI Impact-Elite Agents Hackathon 2026", year: 2026, description: "Spearheaded the end-to-end organization and execution of the 'AI Impact-Elite Agents' hackathon for the entire 2026 intern cohort at ITC Infotech. Designed the core technical theme around 'Agentic AI for Resource Management' to drive innovation in autonomous workflows. Served as a lead technical judge, evaluating complex multi-agent architectures developed by peers based on system viability, codebase scalability, and business impact. Mentored teams throughout the event, fostering a culture of collaborative engineering and establishing best practices for AI development.", type: "leadership" },
