        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Cybersecurity & AI Engineer blending deep AI/ML expertise with security operations. Deep ML background across adversarial robustness, multi-agent systems, and threat detection.
            </p>
          </div>
